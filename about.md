...
### Legacy & Artifacts
* **[42ctf.org](https://www.42ctf.org)**: In 2019, I spawned this CTF platform to give 42 students and InfoSec masochists a place to sharpen their blades. It’s still out there, lurking in the shadows *sound of a dark mage skeleton in minecraft or something like that idk i don't play minecraft*.

* **The Repository**: My GitHub is a graveyard of half-finished masterpieces and "temporary" fixes that became permanent.
...
* **Signal:** `{{ site.author.email }}`
* **The Vault:** [github.com/{{ site.author.username }}](https://github.com/{{ site.author.username }})